...
class study(osv.osv):
    ...
    _columns = {
        ...
        'concentration': fields.char(string='Concentration', readonly=True, size=128, states={'draft': [('readonly', False)], 'contracted': [('readonly', False)], 'sp_approved': [('readonly', False)], 'received': [('readonly', False)], 'requested': [('readonly', False)]}),
