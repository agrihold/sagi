...
class technical_product_registry(osv.osv):
    ...
    _inherit = 'sgr.technical_product_registry'
    ...
    def name_get(self, cr, uid, ids, context=None):
        ...
        if isinstance(ids, (long, int)):
            ids = [ids]
        reads = self.read(cr, uid, ids, ['technical_product_id','registry_category_id','operative_id'], context=context)
        res = []
        for record in reads:
            name = record['technical_product_id'][1]
    ...
    def create(self, cr, uid, vals, context=None):
        ids = super(technical_product_registry, self).create(cr, uid, vals, context=context)
        super(technical_product_registry, self).write(cr, uid, ids, {}, context=context)
        return ids
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        ret = super(technical_product_registry, self).write(cr, uid, ids, vals, context=context)
