...
class trademark_registry(osv.osv):
    ...
    _inherit = 'sgr.trademark_registry'
    
    _rec_name = 'computed_name'

    def create(self, cr, uid, vals, context=None):
        ids = super(trademark_registry, self).create(cr, uid, vals, context=context)
        super(trademark_registry, self).write(cr, uid, ids, {}, context=context)
        return ids
    ...
    def write(self, cr, uid, ids, vals, context=None):
        ...
        ret = super(trademark_registry, self).write(cr, uid, ids, vals, context=context)
